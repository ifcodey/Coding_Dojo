package com.axsos.fullcruds.controllers;

import com.axsos.fullcruds.models.Expense;
import com.axsos.fullcruds.services.ExpenceService;
...
public class ExpenseController {
	...
	@PutMapping("/edit/{id}")
	public String editExpense(@Valid @ModelAttribute(value = "expenseToEdit") Expense expenseToEdit,
	...
	public String showExpense(@PathVariable("id") Long id, Model model) {
		...
		model.addAttribute("expence", expense);
		return "/expence.jsp";
	}
