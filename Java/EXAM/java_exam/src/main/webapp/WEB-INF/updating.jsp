...
<section class=" d-flex p-2 flex-row-reverse">
    <div class="align-items-end">
        <span class="p-2"><a href="/logout">Logout</a></span> <span
            class="p-2"><a href="/dash">Home</a></span>
        <span class="p-2"><a href="/team/edit/${currentTeam.id}">Refresh</a></span>
    </div>
</section>

<div class=".d-flex p-2 justify-content-center m-5">

    <form:form method="post" action="/team/edit/${currentTeam.id}" modelAttribute="team_update">
        ...
        <div>
            <table class="table">
                ...
                <tr>
                    ...
                    <th>
                        <form:input path="name" type="text" style="width:500px;" value="${currentTeam.name}"/>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th>
                        <form:input path="level" type="text" style="width:500px; " value="${currentTeam.level}"/>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th>
                        <form:input path="day" type="text" style="width:500px; " value="${currentTeam.day}"/>
                    </th>
