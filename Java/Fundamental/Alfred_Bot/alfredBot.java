...
public class AlfredTest {
    ...
    public static void main(String[] args) {
        ...
        // sensi bouns
        String responseAngry = alfredBot.respondStausAlfred("alfred is  Angry");
        String responseSad = alfredBot.respondStausAlfred("alfred is  Sad");
        String responseSomething = alfredBot.respondStausAlfred("alfred is something");
