...
<div class=".d-flex p-2 justify-content-center m-5">
    ...
    <form:form method="post" action="/trip/edit/${trip.id}" modelAttribute="trip">
        ...
        <div>
            <table class="table">
                ...
                <tr>
                    ...
                    <th>
                        <form:input path="title" type="text" style="width:500px;" value="${trip.title}"/>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th>
                        <form:input path="capacityTotal" type="number" style="width:500px; " value="${trip.capacityTotal}"/>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th>
                        <form:input path="detail" type="text" style="width:500px; " value="${trip.detail}"/>
                    </th>
