package com.axsos.countriesAndCities.reposiries;
...
import com.axsos.countriesAndCities.models.Country;
import com.axsos.countriesAndCities.models.City;

@Repository
public interface All_Repo extends CrudRepository<Country, Long> {
	...
	/*
	 * @Query(value =
	 * "select A.name,count(A.Code) AS NumberOfCities from country AS A join city AS B on A.code = B.country_code group by A.code order by NumberOfCities desc "
	 * , nativeQuery = true) List<Object[]> displayTotalCities();
	 * 
	 * @Query(value =
	 * "select * from cities where country_code=\"MEX\" AND population > 500000 order by population desc;"
	 * , nativeQuery = true) List<Object[]> q3();
	 * 
	 * @Query(value =
	 ...
	 * , nativeQuery = true) List<Object[]> q6();
	 * 
	 * @Query(value =
	 ...
	 * , nativeQuery = true) List<Object[]> q7();
	 * 
	 * @Query(value =
	 ...
	 * , nativeQuery = true) List<Object[]> q8();
	 */
}
