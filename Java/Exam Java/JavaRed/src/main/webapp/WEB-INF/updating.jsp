...
<div class=".d-flex p-2 justify-content-center m-5">
    ...
    <form:form method="post" action="/trip/edit/${currentTrip.id}" modelAttribute="trip">
        ...
        <div>
            <table class="table">
                ...
                <tr>
                    ...
                    <th>
                        <form:input path="title" type="text" style="width:500px;" value="${currentTrip.title}"/>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th>
                        <form:input path="capacityTotal" type="number" style="width:500px; " value="${currentTrip.capacityTotal}"/>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th>
                        <form:input path="detail" type="text" style="width:500px; " value="${currentTrip.detail}"/>
                    </th>
    ...
    <br>
    <a href="/delete/${currentTrip.id}" class="btn btn-danger"> Delete</a>
</div>
</body>
</html>
